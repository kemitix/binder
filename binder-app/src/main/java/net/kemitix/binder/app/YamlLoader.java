...
public class YamlLoader {
    ...
    public  <T extends Section> T loadSectionFile(
        ...
        T section = parseYamlFromFile(file, theRoot, String.join(System.lineSeparator(), header));
    ...
    private <T> T parseYamlFromFile(File file, Class<T> theRoot, String header) throws IOException {
